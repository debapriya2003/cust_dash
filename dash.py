...
# Load Excel files
# ----------------------------
transactions = load_and_clean_excel(".venv/cutomer_dash/2024_1.xlsx", "Sheet1")
customers = load_and_clean_excel(".venv/cutomer_dash/CUSTOMER_TABLE NEW.xlsx", "Sheet1")
items = load_and_clean_excel(".venv/cutomer_dash/ITEM_LIST.xlsx", "ITEM_LIST")
locations = load_and_clean_excel(".venv/cutomer_dash/location.xlsx", "Sheet1")
